// src/pages/maindashborad/WorkOrders/Alert.jsx
...
const Alert = ({ type, message, onClose, duration = 5000 }) => {
  ...
  let alertClass = 'bg-gray-100 border-gray-500 text-gray-700';
  let icon = null;
  ...
  return (
    <div className={`border-l-4 ${alertClass} p-4 mb-4 fixed top-4 right-4 z-50 rounded shadow-md`}>
